...
export default function CategoryCoursePageContent({ categoryId }: { categoryId: string }) {
  return (
          ...
          >
            <GlassCard className="p-12 border-[#5B5EFF]/20 bg-[#5B5EFF]/5 flex flex-col items-center gap-6">
              ...
              <p className="text-[#9496C0] text-lg max-w-xl mx-auto">
                نعمل حالياً على إعداد محتوى تدريبي متميز لهذا القسم ({categoryId}). سيتم إضافته قريباً!
              </p>
