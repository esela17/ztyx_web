  ...
  return (
    <div className="w-full bg-[#0D0F1A] border-y border-[#9496C0]/10 py-16 relative z-10" ref={containerRef as any}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 md:gap-0 md:divide-x md:divide-x-reverse md:divide-[#9496C0]/10">
          {stats.map((stat, i) => (
            <div key={i} className="text-center group gsap-reveal px-8">
              <div className="relative mb-4 inline-block">
                <div className="text-5xl md:text-6xl font-black text-[#F0F1FF] font-mono tracking-tighter group-hover:text-[#5B5EFF] transition-colors duration-500">
                  {stat.value}
                </div>
