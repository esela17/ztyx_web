        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {pillars.map((pillar, i) => (
            <div key={i} className="gsap-reveal">
              <GlassCard 
                className="p-12 rounded-[40px] text-center group hover:-translate-y-4 hover:border-[#5B5EFF]/50 hover:shadow-[0_20px_60px_rgba(91,94,255,0.2)] transition-all duration-500 cursor-pointer"
              >
