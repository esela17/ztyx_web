...
export const BoxesCore = ({ className, ...rest }: { className?: string }) => {
  ...
  // Using direct color values instead of CSS variables for better compatibility
  const colors = [
    "rgb(91 94 255)", // brand-blue
    "rgb(58 61 200)", // dark-blue
    "rgb(125 211 252)", // sky-300
    "rgb(147 197 253)", // blue-300
    "rgb(165 180 252)", // indigo-300
    "rgb(196 181 253)", // violet-300
    "rgb(240 241 255)", // light-text-tint
  ];
