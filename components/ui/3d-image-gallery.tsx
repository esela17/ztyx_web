...
export default function StellarCardGallerySingle() {
  return (
    <CardProvider>
      <div className="w-full h-[600px] relative overflow-hidden bg-black rounded-[40px] border border-white/10">
        <StarfieldBackground />
        ...
        <div className="absolute top-8 left-8 z-20 text-white pointer-events-none">
          <h1 className="text-3xl font-black mb-2 uppercase tracking-tighter">Stellar Gallery</h1>
          <p className="text-sm opacity-50 uppercase tracking-widest font-bold">Drag to explore • Scroll to zoom</p>
        </div>
      </div>
    </CardProvider>
  )
