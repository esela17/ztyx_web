...
const inputClass =
  "w-full h-12 px-4 rounded-xl text-white placeholder-[#5a5c7a] text-sm outline-none transition-all focus:border-[#5B5EFF]";

export default function PythonDiplomaPage() {
        ...
        <div className="w-full max-w-2xl mx-auto">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 80px rgba(91,94,255,0.1), 0 30px 60px rgba(0,0,0,0.3)",
            }}
          >
            {/* Glow top line */}
              ...
              {step === "details" && (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#FFD43B]/20 to-[#5B5EFF]/20 flex items-center justify-center text-3xl flex-shrink-0">
                      🐍
                    </div>
                    <div>
                      <p className="text-xs text-[#5B5EFF] font-semibold uppercase tracking-widest mb-1">ZTYX Company</p>
                      <h1 className="text-2xl md:text-3xl font-black text-white">دبلومة Python</h1>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                    {pythonTopics.map((topic) => (
                      <div key={topic} className="flex items-center gap-2 text-sm text-[#F0F1FF] bg-white/5 p-3 rounded-xl border border-white/5">
                  ...
                  <div className="flex flex-col sm:flex-row flex-wrap gap-4 mb-10">
                    <div className="flex items-center gap-2 text-sm text-[#9496C0] bg-white/5 px-4 py-2 rounded-xl">
                      <Users className="w-5 h-5 text-[#FFD43B]" />
                      <span>
                        متبقي{" "}
                    ...
                    <div className="flex items-center gap-2 text-sm text-[#9496C0] bg-white/5 px-4 py-2 rounded-xl">
                      ...
                      <span>استثمر إجازتك في مهارة حقيقية</span>
                    </div>
                  </div>
              ...
              {step === "form" && (
                ...
                >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {/* Referral */}
                    <div>
                      <label className="text-sm text-[#9496C0] mb-2 block font-medium">كيف عرفت عن ZTYX؟</label>
                      <select
                    ...
                    <label className="flex items-start gap-3 cursor-pointer group mt-4">
                      ...
                      <span className="text-sm text-[#9496C0] leading-relaxed group-hover:text-white transition-colors">
                        أؤكد أنني سألتزم بجميع سياسات الدبلومة وأهدافها وسأبذل جهدي للتعلم والاستفادة القصوى.
                      </span>
                    </label>
              ...
              {step === "success" && (
                ...
                >
                  ...
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-black text-white mb-2">تم الحجز! 🎉</h2>
                  ...
                  <div className="space-y-3 mb-8">
                    ...
                    >
                      <button
                        ...
                        className="flex items-center gap-2 text-sm transition-colors hover:text-[#5B5EFF]"
                  ...
                  >
                    ...
                    <p className="text-[#9496C0] text-sm mb-5">
                      بعد الدفع، أرسل صورة الإيصال لتأكيد مقعدك وحجز الدبلومة بشكل نهائي
                    </p>
